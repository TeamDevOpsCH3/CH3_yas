...
def microservices = [
    ...
    [id: 'backoffice-bff', display: 'Backoffice BFF Service', enableTest: false, enableCoverage: false, enableBuild: false, commands: []],  // Unit tests added
    ...
    [id: 'search',         display: 'Search Service',         enableTest: false, enableCoverage: false, enableBuild: false, commands: []],  // Has unit tests in src/test
    ...
    [id: 'recommendation', display: 'Recommendation Service', enableTest: false, enableCoverage: false, enableBuild: false, commands: []],  // Has implementation, tests need Testcontainers
