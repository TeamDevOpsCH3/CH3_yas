...
class AbstractCircuitBreakFallbackHandlerTest {
    ...
    void handleBodilessFallback_rethrowsSameException() {
        ...
        RuntimeException thrown = assertThrows(RuntimeException.class, () -> handler.callBodiless(ex));
    ...
    void handleTypedFallback_rethrowsSameException() {
        TestHandler handler = new TestHandler();
        IllegalStateException ex = new IllegalStateException("typed");

        IllegalStateException thrown = assertThrows(IllegalStateException.class, () -> handler.callTyped(ex));
